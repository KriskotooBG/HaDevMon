namespace Communication.Mqtt.Configuration
{
    public sealed class MqttOptions
    {
        ...
        public string DiscoveryOriginName { get; init; } = "HaDevMon";

        public string HomeAssistantStatusTopic { get; init; } = "homeassistant/status";
        public TimeSpan HomeAssistantBirthDelayMax { get; init; }= TimeSpan.FromSeconds(5);
